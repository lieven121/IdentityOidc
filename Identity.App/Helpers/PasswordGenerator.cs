...
//https://www.siepman.nl/blog/random-password-generator-with-numbers-and-special-characters
...
public class PasswordGenerator
{
    ...
    public static string QuicklyGeneratePassword(int minimumLengthPassword = 8, int maximumLengthPassword = 15)
    {
        var generator = new PasswordGenerator(minimumLengthPassword, maximumLengthPassword);
